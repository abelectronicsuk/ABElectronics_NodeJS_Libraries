/** 
* ================================================
* AB Electronics UK IO Pi Unit Tests | test setBusDirection function
*
* run with: node setBusDirection
* ================================================

This test validates the setBusDirection function in the IoPi class.
...
test.start_test("IOPi class > setBusDirection()");
