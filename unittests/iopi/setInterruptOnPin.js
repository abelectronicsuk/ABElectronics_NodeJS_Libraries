/** 
* ================================================
* AB Electronics UK IO Pi Unit Tests | test setInterruptOnPin function
*
* run with: node setInterruptOnPin
* ================================================

This test validates the setInterruptOnPin function in the IoPi class.
...
test.start_test("IOPi class > setInterruptOnPin()");
...
for (var x = 1; x <= 8; x++)
{
    ...
    bus.setInterruptOnPin(x, 1);

    var y = test.i2c_emulator_read_word_data(test.MCP23017_GPINTENA);
...
for (var x = 9; x <= 16; x++)
{
    ...
    var y = test.i2c_emulator_read_word_data(test.MCP23017_GPINTENB);
