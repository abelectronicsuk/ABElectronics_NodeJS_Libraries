/** 
* ================================================
* AB Electronics UK IO Zero 32 Unit Tests | test readPort function
*
* run with: node readPort
* ================================================

This test validates the readPort function in the IOZero32 class.
...
test.start_test("IOZero32 class > readPort()");
