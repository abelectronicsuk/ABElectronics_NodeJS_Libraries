...
* Version 2.1 Updated 07/03/2024
...
PWM = (function (address) {
    ...
    // rpio object for gpio communications
    var rpio = require('rpio');

    // i2c object for i2c communications
    ...
    function i2cReadByte(register) {
        ...
        const rxdata = i2c1.readByteSync(i2caddress, register);
        i2c1.closeSync();
    ...
    function i2cWriteByte(register, val) {
        const i2c1 = i2c.openSync(busnumber);
        i2c1.writeByteSync(i2caddress, register, val);
        i2c1.closeSync();
    }
