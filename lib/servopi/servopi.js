...
PWM = (function (address) {
     ...
     * @param  {number} calibration - Oscillator calibration offset. Use this to adjust for oscillator drift.  Value normally between -10 and 10
     */
    PWM.prototype.setPWMFrequency = function (freq, calibration) {

        // check if channel value was set
...
Servo = (function (address, low_limit, high_limit, reset) {
     ...
     * @param  {number} channel - 1 to 16. If channel is omitted or set as 0 the value will be set for all channels.
     */
