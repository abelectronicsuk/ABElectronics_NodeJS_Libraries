...
ADCDifferentialPi = (function () {
    const i2c = require('i2c-bus');

    const busnumber = 1; // The number of the I2C bus/adapter to open, 0 for /dev/i2c-0, 1 for /dev/i2c-1, ...
    
    ADCDifferentialPi.prototype.i2cAddress1 = 0x68;
    ADCDifferentialPi.prototype.i2cAddress2 = 0x69;
    ADCDifferentialPi.prototype.pga = 0.5;
    ADCDifferentialPi.prototype.bitRate = 18;
    ADCDifferentialPi.prototype.conversionMode = 1;

    ADCDifferentialPi.prototype.config1 = 0x9C;  // PGAx1, 18 bit, continuous conversion, channel 1
    ADCDifferentialPi.prototype.config2 = 0x9C;  // PGAx1, 18 bit, continuous-shot conversion, channel 1
    ADCDifferentialPi.prototype.lsb = 0.0000078125;  // default this.lsb value for 18 bit
    ADCDifferentialPi.prototype.signBit = false; // stores whether the value contains a sign bit showing it is positive or negative.
    ...
    ADCDifferentialPi.prototype.readVoltage = function (channel) {
        ...
        {
            console.log("lsb = " + String(this.lsb) + ", pga = " + String(this.pga))
            return raw * (this.lsb / this.pga) - 2.048 / (this.pga * 2);
        }
        else {
            return raw * (this.lsb / this.pga); // calculate the voltage and return it
        }
    };
