/** 
*
* AB Electronics UK Expander Pi - 32 Digital IO, 8 ADC, 2 DAC and a real-time clock
...
ExpanderPiADC = (function () {
    ...
    let tx = Buffer.alloc(3, [0x01, 0xC0, 0x00]);
    let rx = Buffer.alloc(3, [0, 0, 0]);
    let out;
     ...
     * When in differential mode, setting the channel to 3 will make IN3 = IN+ and IN4 = IN-
     * When in differential mode, setting the channel to 4 will make IN3 = IN- and IN4 = IN+
     * When in differential mode, setting the channel to 5 will make IN5 = IN+ and IN6 = IN-
     * When in differential mode, setting the channel to 6 will make IN5 = IN- and IN6 = IN+
     * When in differential mode, setting the channel to 7 will make IN7 = IN+ and IN8 = IN-
     * When in differential mode, setting the channel to 8 will make IN7 = IN- and IN8 = IN+
    ...
    ExpanderPiADC.prototype.readADCVoltage = function (channel, mode) {
        return adcRefVoltage / 4096 * this.readADCRaw(channel, mode);
    };
...
ExpanderPiDAC = (function () {
    ...
    let tx = Buffer.alloc(2, [0x00, 0x00]);
    let rx = Buffer.alloc(2);
...
ExpanderPiIO = (function () {
    ...
    */
    ...
    ExpanderPiIO.prototype.i2cReadByte = function (register) {
        const i2c1 = i2c.openSync(busnumber);
        const rxdata = i2c1.readByteSync(this.i2caddress, register);
        i2c1.closeSync();
    ...
    ExpanderPiIO.prototype.i2cWriteByte = function (register, val) {
        const i2c1 = i2c.openSync(busnumber);
        i2c1.writeByteSync(this.i2caddress, register, val);
        i2c1.closeSync();
    };
