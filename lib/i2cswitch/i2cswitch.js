/** 
* ================================================
* ABElectronics I2C Switch controller
...
I2CSwitch = (function (address) {
    ...
    /**
     * Private function to sleep for a number of milliseconds
     */
    ...
    function I2CSwitch(address) {
        ...
        // set GPIO reset pin as an output and set it high.
     ...
     * I2C buses is stuck in a low state.  All channels will be set to an off state.
     */
